  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="npd-upload-title"
      >
        <h2 id="npd-upload-title" class="visually-hidden">New Project — Upload</h2>
        ...
        <div class="npd__card">
          ...
          <label class="visually-hidden" for="npd-upload-title-input">Title</label>
          <input
            id="npd-upload-title-input"
            v-model="title"
            type="text"
            class="npd__input"
            placeholder="Title"
          ...
          <div class="npd__row">
            <div class="npd__field">
              ...
              <div class="npd__readonly">{{ provider }}</div>
            </div>
            <div class="npd__field">
          ...
          <section class="npd__section" aria-labelledby="npd-upload-info-title">
            <h3 id="npd-upload-info-title" class="npd__section-title">Video Information (Default)</h3>
          ...
          <section class="npd__section" aria-labelledby="npd-upload-thumb-title">
            <h3 id="npd-upload-thumb-title" class="npd__section-title">Video Thumbnail (Default)</h3>
...
watch(
  ...
  async ([isOpen, file]) => {
    ...
    if (file) await initFromFile(file)
  },
  { immediate: true },
)
...
async function onSubmit() {
  ...
  submitError.value = ''
  submitProgress.value = 'Preparing upload…'
  ...
  try {
    ...
    submitProgress.value = 'Uploading video…'
    const videoResult = await uploadFileWithCredentials(
      props.file,
      props.file.name,
      'raw_video',
      (percent) => {
        submitProgress.value = `Uploading video… ${percent}%`
      },
    )
